...
<scroll-view scroll-y>
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">开启主题屏蔽通知</text>
  ...
  <view qq:if="{{rolesets.useit}}">
      ...
      <view class="cu-item sm-border arrow">
        ...
        <text class="text-gray">{{channelname==''?'用来发送屏蔽通知的子频道':channelname}}</text>
      </view>
    </view>
  ...
  <view class="margin-top bg-white padding radius-lg">
    ...
    <view class="text-gray text-sm padding-top-xs">用户发布主题内容敏感、发送过快都会导致主题被屏蔽</view>
    <view class="text-gray text-sm padding-top-xs">该功能可在主题被屏蔽时发送通知，艾特发送人</view>
  </view>
</view>
