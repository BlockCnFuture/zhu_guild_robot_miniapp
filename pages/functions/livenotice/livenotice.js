...
Page({
  ...
  sfromc: function (e) {
    ...
    tls.splice(0, 0, { id: '2002', name: '所有直播子频道', type: 10005, sub_type: 0 });
    tls = tls.filter(i => {
      return i.type == 10005 || i.type == 4;
    }).map(i => {
  ...
  stoc: function (e) {
    ...
    arr.splice(0, 0, { id: '0', name: '原子频道', type: 10005, canselect: true, select: false });
