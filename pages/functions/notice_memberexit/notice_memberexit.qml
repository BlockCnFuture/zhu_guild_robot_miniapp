...
<view class="text-blue" style="text-align: left;margin-left:30rpx;font-size:34rpx;" bindtap='addc' data-c='a'>{时间} 用户退出时间</view>
<view class="text-blue" style="text-align: left;margin-left:30rpx;font-size:34rpx;" bindtap='addc' data-c='b'>{昵称} 退出用户昵称</view>
<view class="text-blue" style="text-align: left;margin-left:30rpx;font-size:34rpx;" bindtap='addc' data-c='c'>{id} 退出用户的id</view>
<view class="text-blue" style="text-align: left;margin-left:30rpx;font-size:34rpx;" bindtap='addc' data-c='e'>{计数} 今天第几个退出的用户</view>
...
<scroll-view scroll-y>
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">开启成员退出通知</text>
  ...
  <view qq:if="{{rolesets.useit}}">
    ...
    <view class="cu-list menu sm-border card-menu margin-top" bindtap="navigate" data-url="memberexitoption">
      <view class="cu-item sm-border arrow">
        <text class="text-bold text-black">编辑用户退出频道后操作</text>
