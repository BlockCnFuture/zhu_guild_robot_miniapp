...
<view class="margin">
  ...
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">每日主题身份组奖励</text>
      ...
      <view class="cu-list menu sm-border card-menu margin-top">
        ...
        <view class="cu-item sm-border no-border">
          <text class="text-bold text-black">触发条件</text>
                <view class="flex justify-center align-center bg-white">
                <text class="text-bold text-black margin-right">当日主题</text>
  ...
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">每日主题积分奖励</text>
  ...
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">连续主题身份组奖励</text>
    ...
    <view qq:for="{{rolesets.content.rolesb}}" qq:key="{{index}}">
      <view class="cu-list menu sm-border card-menu margin-top">
        ...
        <view class="cu-item sm-border no-border">
          <text class="text-bold text-black">触发条件</text>
                <view class="flex justify-center align-center bg-white">
                <text class="text-bold text-black margin-right">连续主题</text>
  ...
  <view class="cu-list menu sm-border card-menu margin-top">
    <view class="cu-item sm-border">
      <text class="text-bold text-black">连续主题积分奖励</text>
